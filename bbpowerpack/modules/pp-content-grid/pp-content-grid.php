...
class PPContentGridModule extends FLBuilderModule {
	...
	public function __construct()
	{
		parent::__construct(array(
			...
			'description'   	=> __('Display posts and pages in standard grid, packery or carousel format.', 'bb-powerpack'),
	...
	public function enqueue_scripts()
	{
		...
		if(FLBuilderModel::is_builder_active() || $this->settings->layout == 'grid-packery') {
			$this->add_js( 'jquery-isotope' );
			$this->add_js( 'jquery-packery', $this->url . 'js/packery-mode.pkgd.min.js', array('jquery', 'jquery-isotope'), '2.0.1', true );
		}
				...
				'fields'        => array(
					'layout'        => array(
						...
						'options'       => array(
							...
							'grid-packery'  => __('Packery', 'bb-powerpack'),
